...
function Rating() {
  ...
  return (
    <div style={{ maxWidth: "500px", margin: "0 auto", color: "gray" }}>
      <h2 style={{ color: "#gray", textShadow: "0 0 5px #gray, 0 0 10px #gray" }}>Formulir Komentar</h2>

      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: "1em" }}>
          <label htmlFor="name" style={{ color: "#gray", fontWeight: "bold" }}>Nama:</label>
          <input
            type="text"
            id="name"
            value={name}
            ...
            required
            style={{ width: "100%", padding: "8px", color: "#gray", backgroundColor: "gray", border: "1px solid #gray" }}
          />
        </div>

        <div style={{ marginBottom: "1em" }}>
          <label htmlFor="comment" style={{ color: "#gray", fontWeight: "bold" }}>Komentar:</label>
          <textarea
            id="comment"
            value={comment}
        ...
        <button type="submit" style={{ padding: "10px 15px", backgroundColor: "#white", color: "#white" }}>
          Kirim Komentar
        </button>
      </form>
      ...
      <div style={{ marginTop: "2em" }}>
        <h3 style={{ color: "#gray" }}>Daftar Komentar</h3>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th style={{ border: "1px solid #ddd", padding: "8px", color: "#gray" }}>Nama</th>
              <th style={{ border: "1px solid #ddd", padding: "8px", color: "#gray" }}>Komentar</th>
          ...
          <tbody>
            {feedbacks.map((feedback, index) => (
              <tr key={index}>
                <td style={{ border: "1px solid #ddd", padding: "8px", color: "#gray" }}>{feedback.name}</td>
                <td style={{ border: "1px solid #ddd", padding: "8px", color: "#gray" }}>{feedback.comment}</td>
